...
class CallForPrice extends \Magento\Framework\Model\AbstractModel implements \ReveredPrateek\PrateekPrice\Api\Data\CallForPriceInterface, IdentityInterface
{
    const STATUS_NEW = 1;
    ...
    {
        $this->_init('ReveredPrateek\PrateekPrice\Model\ResourceModel\CallForPrice');
    }
