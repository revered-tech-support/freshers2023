...
class CallForPrice extends \Magento\Framework\Model\AbstractModel implements \Reveredazhar\AzharPrice\Api\Data\CallForPriceInterface, IdentityInterface
{
    const STATUS_NEW = 1;
    ...
    {
        $this->_init('Reveredazhar\AzharPrice\Model\ResourceModel\CallForPrice');
    }
