...
namespace ReveredAzhar\AzharPrice\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    const CONFIG_PATH_GENERAL_ENABLE = 'reveredazhar/general/enable_frontend';

    const CONFIG_PATH_GENERAL_CUSTOMER_GROUP = 'reveredazhar/general/customer_group';
    ...
    public function isModuleOutputDisabled()
    {
        ...
        $isOutputEnabled = $this->_moduleManager->isOutputEnabled('ReveredAzhar_AzharPrice');
