...
namespace Reveredkuldeep\KuldeepPrice\Block\Adminhtml\CallForPrice;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Reveredkuldeep_KuldeepPrice::save')) {
        ...
        if ($this->_isAllowedAction('Reveredkuldeep_KuldeepPrice::delete')) {
