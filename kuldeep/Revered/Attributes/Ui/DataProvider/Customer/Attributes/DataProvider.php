...
namespace Revered\Attributes\Ui\DataProvider\Customer\Attributes;
    ...
    private function customizeOptions($meta)
    {
        ...
        foreach ($this->storeRepository->getList() as $store) {
            ...
            $storeLabelConfiguration = [
                'dataType' => 'text',
                'formElement' => 'input',
                'component' => 'Revered_Attributes/js/form/element/input',
        ...
        ['record']['children']['action_delete'] = $this->arrayManager->set(
            ...
            [
                ...
                'fit' => true,
                'sortOrder' => $sortOrder,
                'component' => 'Revered_Attributes/js/form/element/action-delete',
                'elementTmpl' => 'Revered_Attributes/form/element/action-delete',
                'template' => 'Revered_Attributes/form/element/action-delete',
